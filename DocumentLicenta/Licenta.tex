...
\quad Sistemul a fost evaluat pe setul de date \emph{Avenue} . Ca şi modalitate de evaluare a fost luată în considerare aria de sub curba (eng: \emph {area under the curve (AUC)}) raportată la scorul fiecărui cadru. 
